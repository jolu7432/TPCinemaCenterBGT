...
public class ServletUsuario extends HttpServlet {
	...
	if (isMultipart) {
		...
		//sesion.setAttribute("msg", "prueba error"); 
		ArrayList list = new ArrayList();
		list.add("No se puede borrar usuario, tiene reservas");
	...
	if (mod == null) {
		...
		RequestDispatcher volver = request.getRequestDispatcher("/abmUsuario.jsp?errorUser='El nombre de usuario o mail ya existen'");
